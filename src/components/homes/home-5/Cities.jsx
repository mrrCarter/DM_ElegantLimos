...
export default function Cities() {
  ...
  return (
    <section className="section pt-120 pb-120 bg-primary bg-our-fleet-2 bg-our-service-2">
          ...
          <div className="box-swiper">
            ...
            >
              ...
              <div className="box-pagination-fleet">
                <div className="swiper-button-prev swiper-button-prev-fleet snbnp9">
                  <svg
                    fill="none"
                    stroke="currentColor"
                    strokeWidth="1.5"
                ...
                <div className="swiper-button-next swiper-button-next-fleet snbn9">
                  <svg
                    fill="none"
                    stroke="currentColor"
                    strokeWidth="1.5"
